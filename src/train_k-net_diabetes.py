...
from knetdual.dual_functions import relu
...
def save_metrics_to_csv(losses, train_accuracies, test_accuracies, times,
    base_filename="k-net_TrainDiabetes_10-1.csv"):
...
def main():
    ...
    # model_layers specifies the model layer dimensions. modify to change model structure
    model_layers=[10,1]
    print ("Training k-net with the Diabetes Dataset, model layers = ", model_layers)    
    model = KANetwork(layer_dims=model_layers, knots=knots, activation=relu)
